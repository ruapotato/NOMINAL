...
static const Package PKG_HOME = {
    "nomowner-home", "1.0", "the previous admin's home directory",
    {
      ...
      { "/home/nomowner/Documents/diary.txt",
        ...
        "\"succeeded\". `pkg verify` said CHANGED, which is the honest answer and\n"
        "took me twenty minutes to believe. I have started saying `df` out loud\n"
        "before I do anything, like a prayer.\n"
        "\n"
        "--- JANUARY ---\n"
        "\n"
