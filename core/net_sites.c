...
"obvious.</li>"
"<li><b>WRONG since 10.0:</b> there are no start scripts to run, and -- read\n"
"this part twice -- THERE IS NO RESTART. <b>svc</b> lists the units,\n"
"<b>svc status &lt;name&gt;</b> says what happened to one, and <b>svc\n"
"enable</b> and <b>svc disable</b> decide whether it starts at the NEXT\n"
"boot -- they do not touch what is running now. To make a running daemon\n"
"re-read its configuration, find it in <b>ps</b> and <b>kill -HUP</b> the\n"
"pid; that really does work and /run/&lt;name&gt;.state changes in front of\n"
"you. To make one start over from nothing, the machine goes down. This is\n"
"less of a limitation than it sounds and more of an argument for reading\n"
"the config before you save it.</li>"
